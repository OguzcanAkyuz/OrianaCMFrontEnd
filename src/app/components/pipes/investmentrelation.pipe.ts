...
export class InvestmentrelationPipe implements PipeTransform {
/**
 ...
 transform(value: any[], searchText: string): any[] {
  ...
  return value.filter(it => {
    console.log(it)
    return it.id.toLocaleLowerCase().indexOf(searchText) > -1 || it.investorName .toLocaleLowerCase().indexOf(searchText) > -1 || it.investorSurname .toLocaleLowerCase().indexOf(searchText) > -1 
