...
export class CuriouscustomerPipe implements PipeTransform {
...
/**
 ...
 transform(value: any[], searchText: string): any[] {
  ...
  return value.filter(it => {
    console.log(it)
    return it.id.toLocaleLowerCase().indexOf(searchText) > -1 || it.curiousCustomerName .toLocaleLowerCase().indexOf(searchText) > -1 || it.curiousCustomerSurname .toLocaleLowerCase().indexOf(searchText) > -1 
