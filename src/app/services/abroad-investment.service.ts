...
export class AbroadInvestmentService {
    ...
    getAbroadInvestmentRelation(Id:string):Observable<ListResponseModel<AbroadInvestmentRelation>>{
        let newPath=this.apiUrl+"abroadinvestmentrelation/getbyid="+Id
        return this.httpClient.get<ListResponseModel<AbroadInvestmentRelation>>(newPath);
    }

    add(abroadInvestmentRelation:AbroadInvestmentRelation):Observable<ResponseModel>{
        return this.httpClient.post<ResponseModel>(this.apiUrl+"AbroadInvestmentRelation/add",abroadInvestmentRelation)
    }
}